...
<div id="header" role="banner">
    ...
    <div class="lang">
        <a href="#" id="btnLangSelect" class="sel" role="listbox" aria-expanded="false">
            <span class="lang_text">한국어</span>
        </a>
        <ul class="lang_select_wrap" style="display:none;">
            <li><a href="#" id="btnLangKoKr" class="lang_select"><span class="lang_text">한국어</span></a></li>
            <li><a href="#" id="btnLangEnUs" class="lang_select"><span class="lang_text">English</span></a></li>
            <li><a href="#" id="btnLangHansCn" class="lang_select"><span class="lang_text">中文(简体)</span></a></li>
            <li><a href="#" id="btnLangHansTw" class="lang_select"><span class="lang_text">中文(台灣)</span></a></li>
        </ul>
    </div>
</div>
<!-- //header -->
        ...
        <div class="join_content">
            <div class="join_form">
                <form id="join_form" method="GET" action="/user2/V2Join?m=begin" >
                    <input type="hidden" id="token_sjoin" name="token_sjoin" value="M3RPbuvs2Wqbj5V2">
